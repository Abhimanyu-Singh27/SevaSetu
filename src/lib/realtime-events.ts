...
export async function recordRealtimeEvent(input: { name: RealtimeEventName; actorId: string; audienceUserIds: string[]; payload: Record<string, unknown> }, writer: Prisma.TransactionClient | typeof prisma = prisma) {
