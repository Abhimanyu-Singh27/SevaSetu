...
type WorkerCard = { id?: string; name: string; role: string; skills: string; rating: string; jobs: string; price: string; distance: string; initials: string; color: string };
  ...
  return (
    <main>
      ...
      <section className="hero" id="top">
        ...
        <img className="public-signature" src="/signature.png" alt="Ayush.k signature" />
